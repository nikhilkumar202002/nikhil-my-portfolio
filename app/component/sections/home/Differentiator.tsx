        ...
        <section className="w-full bg-[#F9F9F9] py-16 sm:py-20 lg:py-24">
            <div className="site-container flex flex-col gap-14 sm:gap-16 lg:gap-20">
                ...
                <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
                    ...
                    <p className="max-w-[24rem] text-[14px] font-light leading-[1.45] text-black/70 md:text-right sm:text-[15px]">
                ...
                <div className="grid grid-cols-1 gap-10 pt-2 md:grid-cols-2 lg:gap-16">
                    ...
                    <div className="flex flex-col gap-3 md:items-end md:text-right">
                        ...
                        <div className="flex flex-col gap-2 pt-1 w-full md:items-end">
                            {devSkills.map((row, rowIndex) => (
                                <div
                                    key={rowIndex}
                                    className="flex flex-wrap items-center gap-x-5 gap-y-1 text-base font-normal text-black sm:text-lg md:justify-end"
                                >
                                    {row.map((skill, skillIndex) => (
                                        <span
                                            key={skillIndex}
