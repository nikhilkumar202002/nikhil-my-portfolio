        ...
        <div className="home-about-grid">
          <div className="home-about-copy">
            ...
            <p className="home-about-description">
              I&apos;m Nikhil Kumar, a Web Designer and Frontend Developer who
              combines thoughtful UI/UX design with modern web development to
              create websites that are visually engaging, easy to use,
              responsive across every device, and built around real business
              goals.
            </p>
